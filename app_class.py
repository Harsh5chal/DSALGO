...
##### Setup for Main Menu
    def sketch_main_menu(self):
        ...
        # Draw Buttons
        self.astar_button.draw_button(BLACK)
        self.dijkstra_button.draw_button(BLACK)
...
##### MAIN MENU FUNCTIONS
    ...
    def main_menu_events(self):
        ...
        self.draw_text('Made By : ASHWAJIT SINGH & HARSH PANCHAL', self.screen, [720, 720], 28, WHITE, FONT, centered=True)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEMOTION:
                if self.astar_button.isOver(pos):
                    self.astar_button.colour = PINK
                elif self.dijkstra_button.isOver(pos):
                    self.dijkstra_button.colour = PINK
                else:
                    self.astar_button.colour, self.dijkstra_button.colour = WHITE, WHITE
